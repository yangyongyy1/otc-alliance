...
import { getBusinessByType } from "@/api/commonApi";
...
const fetchBusinessOptions = async () => {
  if (props.businessType === null || props.businessType === undefined) {
    return;
  }
  ...
  try {
    const apiConfig = getBusinessByType(props.businessType);
...
const handleChange = (value) => {
  ...
  emit("change", value, selectedBusiness);
};
...
defineExpose({
  refresh,
  businessOptions: computed(() => businessOptions.value),
});
</script>
