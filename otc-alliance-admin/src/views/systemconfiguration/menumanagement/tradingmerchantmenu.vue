    ...
    <div class="menu-management-wrapper">
      <div class="action-bar">
        <el-button
          ...
          @click="handleAdd"
          v-permission="
            'Pages.SystemConfiguration.MenuManagement.TradingMerchantMenu.BtnAdd'
          "
        >
          增加
        </el-button>
            ...
            <template #default="{ row }">
              <div>
                <el-button
                  ...
                  v-permission="
                    'Pages.SystemConfiguration.MenuManagement.TradingMerchantMenu.BtnEdit'
                  "
                >
                  编辑
                </el-button>
                <el-button
                  ...
                  v-permission="
                    'Pages.SystemConfiguration.MenuManagement.TradingMerchantMenu.BtnDelete'
                  "
                >
                  删除
                </el-button>
