...
public abstract class ClientPlatformWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static ClientPlatformWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(ClientPlatformWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<ClientPlatformDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<ClientPlatformDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<ClientPlatformDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<ClientPlatformDbContext, Task<T>> func)
    {
        T result;
