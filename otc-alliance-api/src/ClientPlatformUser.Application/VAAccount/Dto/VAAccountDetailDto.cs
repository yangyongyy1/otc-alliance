...
using ClientPlatform.Pay.Dto.Callback;

namespace ClientPlatformUser.VAAccount.Dto
{
    [AutoMapFrom(typeof(AccountDetail))]
    public class VAAccountDetailDto:FullAuditedAggregateRoot<int>
    {
        /// <summary>
        /// 账户ID
        /// </summary>
        public int VAAccountId { get; set; }

        /// <summary>
        /// 
        /// </summary>
        public virtual VAAccountDto VAAccount { get; set; }
