...
public class DefaultLanguagesCreator
{
    ...
    {
        var tenantId = ClientPlatformConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
    ...
    public DefaultLanguagesCreator(ClientPlatformDbContext context)
    {
        _context = context;
    }
