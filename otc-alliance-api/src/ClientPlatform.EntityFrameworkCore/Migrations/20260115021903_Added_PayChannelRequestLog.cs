...
{
    /// <inheritdoc />
    public partial class Added_PayChannelRequestLog : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "PayChannelRequestLogs",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PayChannelRequestLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PayChannelRequestLogs_AbpUsers_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PayChannelRequestLogs_UserId",
